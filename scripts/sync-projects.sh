...
if [[ $# -ne 5 ]]; then
  echo "Usage: $0 <aidata-source> <tptrees-source> <sporttech-source> <48directory-source> <portal-root>" >&2
  exit 64
fi
...
mkdir -p "$portal_root/aidata/assets" "$portal_root/tptrees" "$portal_root/sporttech/assets" "$portal_root/48DIRECTORY/assets"
...
echo "Synced AI Data, TP Trees, SportTech, and 48 DIRECTORY into the portal repository."
