...
- `aidata/index.html`：AI Data 正式專案網址入口，目前同步 `ai_industry_penetration_2026-07-13.html`。
...
每次本機更新任何項目時，也必須檢查 `AI 公司估值排行榜` 是否仍為最新可追溯數據，包含私人公司最近一輪已完成估值、上市公司市值基準日、30 日股價比較區間、來源連結與資料整理時間；若沿用既有數據，需確認頁面上的基準日與來源說明仍合理。
